...
with st.expander("**Why build this?**"):
    st.markdown(""" 
            ...
            After a stint as an Assistant and the Offensive Co-Ordinator with the Dallas Mavericks and Mavs Gaming, I became the GM and Head Coach of the Toronto Raptors' - Raptors Uprising in 2023 where statistical thinking
            became my leverage point in systematically engineering an honest rebuild plan to be a playoff contender in two years. 
            
            The global problem? Objectivity is not always invested in, simply because the internal ecosystem is too small and therefore has to run like a startup, where every dollar counts.
            ...
            As a result, all front office operations are a one or two man job; all good coaches end up working 10-12 hour days in season, usually 6-7 days a week and information is often forced to the backseat just because so much more needs to be done.
...
with st. expander("**You want to be in the 2K League? Here's five things you need to know:**"):
    st.write("""
            ...
            4. The only reason you should be doing this job is because you love it. If you are using the 2K League as a resume builder I promise you 80% of the time it will not work (unless that other thing you want to do is also in Esports).
